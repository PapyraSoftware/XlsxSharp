        ...
        IXLWithRichString
{
    ...
    IXLFormattedText<T> SetBold(Boolean value);
    IXLFormattedText<T> SetItalic();
    IXLFormattedText<T> SetItalic(Boolean value);

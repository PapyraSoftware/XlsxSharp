...
internal class XLDrawingStyle : IXLDrawingStyle
{
    public XLDrawingStyle()
    {
        ...
        this.Alignment = new XLDrawingAlignment(this);
        this.ColorsAndLines = new XLDrawingColorsAndLines(this);
        this.Size = new XLDrawingSize(this);
        this.Protection = new XLDrawingProtection(this);
        this.Properties = new XLDrawingProperties(this);
        this.Margins = new XLDrawingMargins(this);
        this.Web = new XLDrawingWeb(this);
    }
    ...
    public static IXLDrawingStyle DefaultCommentStyle
    {
        get
        {
            XLDrawingStyle defaultCommentStyle = new();

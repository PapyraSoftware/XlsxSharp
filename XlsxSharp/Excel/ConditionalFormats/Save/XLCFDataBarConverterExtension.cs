...
internal class XLCFDataBarConverterExtension : IXLCFConverterExtension
{
    private static readonly IReadOnlyDictionary<
        DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues,
        ConditionalFormattingValueObjectTypeValues
    > CFValueToTypeMap = new Dictionary<
        DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues,
        ConditionalFormattingValueObjectTypeValues
    >
    {
        {
            DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues.Max,
            ConditionalFormattingValueObjectTypeValues.AutoMax
        },
        {
            DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues.Min,
        ...
        {
            DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues.Percent,
            ConditionalFormattingValueObjectTypeValues.Percent
        },
        {
            DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues.Percentile,
            ConditionalFormattingValueObjectTypeValues.Percentile
        },
        {
            DocumentFormat.OpenXml.Spreadsheet.ConditionalFormatValueObjectValues.Formula,
    ...
    )
    {
        ...
        ConditionalFormattingValueObjectTypeValues cfMinType = cf.ContentTypes.TryGetValue(
            1,
            out XLCFContentType contentType1
        )
            ? GetCFType(contentType1.ToOpenXml())
            : ConditionalFormattingValueObjectTypeValues.AutoMin;
        ConditionalFormattingValueObject cfMin = new() { Type = cfMinType };
        ...
        ConditionalFormattingValueObjectTypeValues cfMaxType = cf.ContentTypes.TryGetValue(
            2,
            out XLCFContentType contentType2
        )
            ? GetCFType(contentType2.ToOpenXml())
            : ConditionalFormattingValueObjectTypeValues.AutoMax;
        ConditionalFormattingValueObject cfMax = new() { Type = cfMaxType };
        ...
        BarAxisColor barAxisColor = new() { Rgb = XLColor.Black.Color.ToHex() };

        NegativeFillColor negativeFillColor = new() { Rgb = cf.Colors[1].Color.ToHex() };

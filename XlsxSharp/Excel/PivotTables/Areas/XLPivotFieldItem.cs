...
internal class XLPivotFieldItem
{
    ...
    internal XLPivotFieldItem(XLPivotTableField pivotField, int? itemIndex)
    {
        ...
        this._pivotTable = pivotField.PivotTable;
    ...
    private bool ValueIsData => this.ItemType == XLPivotItemType.Data;
    ...
    internal XLCellValue? GetValue()
    {
        ...
        int fieldIndex = this._pivotTable.GetFieldIndex(this._pivotField);
        XLPivotCacheSharedItems sharedItems = this._pivotTable.PivotCache.GetFieldSharedItems(
            fieldIndex
        );
        int itemIndex = this.ItemIndex.Value;

...
public interface IXLRange : IXLRangeBase
{
    ...
    public IXLRangeColumn Column(int columnNumber);

    /// <summary>
    /// Gets the specified column of the range.
    /// </summary>
    /// <param name="columnLetter">Column letter.</param>
    public IXLRangeColumn Column(string columnLetter);
    ...
    public IXLRangeColumns ColumnsUsed(
        XLCellsUsedOptions options,
        Func<IXLRangeColumn, bool> predicate = null
    );

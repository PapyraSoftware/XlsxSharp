...
/// <summary>
/// A universal two-way mapper of string representation of an enum value in the OOXML to XlsxSharp enum.
/// </summary>
internal sealed class XmlToEnumMapper : IEnumMapper
{
    ...
    {
        BiDictionary<string, TEnum> enumMap = this.GetEnumMap<TEnum>();
    ...
    private static XmlToEnumMapper CreateSpreadsheetMapper()
    {
        ...
        // ST_FontScheme
        builder.Add(
            new BiDictionary<string, XLFontScheme>
            {
        ...
        // ST_UnderlineValues
        builder.Add(
            new BiDictionary<string, XLFontUnderlineValues>
            {
        ...
        // ST_VerticalAlignRun
        builder.Add(
            new BiDictionary<string, XLFontVerticalTextAlignmentValues>
            {
        ...
        // ST_PatternType
        builder.Add(
            new BiDictionary<string, XLFillPatternValues>
            {
        ...
        // ST_BorderStyle
        builder.Add(
            new BiDictionary<string, XLBorderStyleValues>
            {
        ...
        builder.Add(
            new BiDictionary<string, XLAlignmentHorizontalValues>
            {
        ...
        builder.Add(
            new BiDictionary<string, XLAlignmentVerticalValues>
            {
        ...
        // ST_GradientType
        builder.Add(
            new BiDictionary<string, XLGradientType>
            {

...
internal static class EnumConverter
{
    ...
    public static ShowDataAsValues ToOpenXml(this XLPivotCalculation value)
    {
        switch (value)
        {
            ...
            case XLPivotCalculation.PercentageOf:
                return ShowDataAsValues.Percent;
            case XLPivotCalculation.PercentageDifferenceFrom:
                return ShowDataAsValues.PercentageDifference;
            case XLPivotCalculation.RunningTotal:
                return ShowDataAsValues.RunTotal;
            case XLPivotCalculation.PercentageOfRow:
                return ShowDataAsValues.PercentOfRaw; // There's a typo in the OpenXML SDK =)
            case XLPivotCalculation.PercentageOfColumn:
                return ShowDataAsValues.PercentOfColumn;
            case XLPivotCalculation.PercentageOfTotal:
    ...
    public static DateTimeGroupingValues ToOpenXml(this XLDateTimeGrouping value)
    {
        switch (value)
        {
            case XLDateTimeGrouping.Year:
                return DateTimeGroupingValues.Year;
            case XLDateTimeGrouping.Month:
                return DateTimeGroupingValues.Month;
            case XLDateTimeGrouping.Day:
                return DateTimeGroupingValues.Day;
            case XLDateTimeGrouping.Hour:
                return DateTimeGroupingValues.Hour;
            case XLDateTimeGrouping.Minute:
                return DateTimeGroupingValues.Minute;
            case XLDateTimeGrouping.Second:
                return DateTimeGroupingValues.Second;
    ...
    public static Vml.StrokeLineStyleValues ToOpenXml(this XLLineStyle value)
    {
        switch (value)
        {
            case XLLineStyle.Single:
                return Vml.StrokeLineStyleValues.Single;
            case XLLineStyle.ThickBetweenThin:
                return Vml.StrokeLineStyleValues.ThickBetweenThin;
            case XLLineStyle.ThickThin:
                return Vml.StrokeLineStyleValues.ThickThin;
            case XLLineStyle.ThinThick:
                return Vml.StrokeLineStyleValues.ThinThick;
            case XLLineStyle.ThinThin:
                return Vml.StrokeLineStyleValues.ThinThin;
    ...
    public static TimePeriodValues ToOpenXml(this XLTimePeriod value)
    {
        switch (value)
        {
            case XLTimePeriod.Yesterday:
                return TimePeriodValues.Yesterday;
            case XLTimePeriod.Today:
                return TimePeriodValues.Today;
            case XLTimePeriod.Tomorrow:
                return TimePeriodValues.Tomorrow;
            case XLTimePeriod.InTheLast7Days:
                return TimePeriodValues.Last7Days;
            case XLTimePeriod.LastWeek:
                return TimePeriodValues.LastWeek;
            case XLTimePeriod.ThisWeek:
                return TimePeriodValues.ThisWeek;
            case XLTimePeriod.NextWeek:
                return TimePeriodValues.NextWeek;
            case XLTimePeriod.LastMonth:
                return TimePeriodValues.LastMonth;
            case XLTimePeriod.ThisMonth:
                return TimePeriodValues.ThisMonth;
            case XLTimePeriod.NextMonth:
                return TimePeriodValues.NextMonth;
        ...
        switch (value)
        {
            ...
            default:
                throw new ArgumentOutOfRangeException(
                    nameof(value),
                    "XLPivotAreaValues value not implemented"
                );
        }
    }
    ...
    public static X14.SparklineTypeValues ToOpenXml(this XLSparklineType value)
    {
        switch (value)
        {
            case XLSparklineType.Line:
                return X14.SparklineTypeValues.Line;
            case XLSparklineType.Column:
                return X14.SparklineTypeValues.Column;
            case XLSparklineType.Stacked:
                return X14.SparklineTypeValues.Stacked;
    ...
    public static X14.SparklineAxisMinMaxValues ToOpenXml(this XLSparklineAxisMinMax value)
    {
        switch (value)
        {
            case XLSparklineAxisMinMax.Automatic:
                return X14.SparklineAxisMinMaxValues.Individual;
            case XLSparklineAxisMinMax.SameForAll:
                return X14.SparklineAxisMinMaxValues.Group;
            case XLSparklineAxisMinMax.Custom:
                return X14.SparklineAxisMinMaxValues.Custom;
    ...
    public static X14.DisplayBlanksAsValues ToOpenXml(this XLDisplayBlanksAsValues value)
    {
        switch (value)
        {
            case XLDisplayBlanksAsValues.Interpolate:
                return X14.DisplayBlanksAsValues.Span;
            case XLDisplayBlanksAsValues.NotPlotted:
                return X14.DisplayBlanksAsValues.Gap;
            case XLDisplayBlanksAsValues.Zero:
                return X14.DisplayBlanksAsValues.Zero;
    ...
    public static FieldSortValues ToOpenXml(this XLPivotSortType value)
    {
        switch (value)
        {
            case XLPivotSortType.Default:
                return FieldSortValues.Manual;
            case XLPivotSortType.Ascending:
                return FieldSortValues.Ascending;
            case XLPivotSortType.Descending:
                return FieldSortValues.Descending;
    ...
    > UnderlineValuesMap = new Dictionary<UnderlineValues, XLFontUnderlineValues>
    {
    ...
    private static readonly IReadOnlyDictionary<
        OrientationValues,
        XLPageOrientation
    > OrientationMap = new Dictionary<OrientationValues, XLPageOrientation>
    {
    ...
    > VerticalAlignmentRunMap = new Dictionary<
        VerticalAlignmentRunValues,
        XLFontVerticalTextAlignmentValues
    >
    {
    ...
    private static readonly IReadOnlyDictionary<
        BorderStyleValues,
        XLBorderStyleValues
    > BorderStyleMap = new Dictionary<BorderStyleValues, XLBorderStyleValues>
    {
    ...
    > HorizontalAlignmentMap = new Dictionary<
        HorizontalAlignmentValues,
        XLAlignmentHorizontalValues
    >
    {
        { HorizontalAlignmentValues.Center, XLAlignmentHorizontalValues.Center },
        {
            ...
            XLAlignmentHorizontalValues.CenterContinuous
        },
    ...
    > VerticalAlignmentMap = new Dictionary<VerticalAlignmentValues, XLAlignmentVerticalValues>
    {
    ...
    > CellCommentsMap = new Dictionary<CellCommentsValues, XLShowCommentsValues>
    {
    ...
    private static readonly IReadOnlyDictionary<
        PrintErrorValues,
        XLPrintErrorValues
    > PrintErrorMap = new Dictionary<PrintErrorValues, XLPrintErrorValues>
    {
    ...
    private static readonly IReadOnlyDictionary<
        CalculateModeValues,
        XLCalculateMode
    > CalculateModeMap = new Dictionary<CalculateModeValues, XLCalculateMode>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ReferenceModeValues,
        XLReferenceStyle
    > ReferenceModeMap = new Dictionary<ReferenceModeValues, XLReferenceStyle>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLTotalsRowFunction
    > TotalsRowFunctionMap = new Dictionary<TotalsRowFunctionValues, XLTotalsRowFunction>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLAllowedValues
    > DataValidationMap = new Dictionary<DataValidationValues, XLAllowedValues>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLErrorStyle
    > DataValidationErrorStyleMap = new Dictionary<DataValidationErrorStyleValues, XLErrorStyle>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLOperator
    > DataValidationOperatorMap = new Dictionary<DataValidationOperatorValues, XLOperator>
    {
    ...
    > SheetStateMap = new Dictionary<SheetStateValues, XLWorksheetVisibility>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLPhoneticAlignment
    > PhoneticAlignmentMap = new Dictionary<PhoneticAlignmentValues, XLPhoneticAlignment>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLPivotSummary
    > DataConsolidateFunctionMap = new Dictionary<DataConsolidateFunctionValues, XLPivotSummary>
    {
        ...
        { DataConsolidateFunctionValues.StandardDeviation, XLPivotSummary.StandardDeviation },
        {
            ...
            XLPivotSummary.PopulationStandardDeviation
        },
    ...
    private static readonly IReadOnlyDictionary<
        ShowDataAsValues,
        XLPivotCalculation
    > ShowDataAsMap = new Dictionary<ShowDataAsValues, XLPivotCalculation>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLFilterOperator
    > FilterOperatorMap = new Dictionary<FilterOperatorValues, XLFilterOperator>
    {
    ...
    private static readonly IReadOnlyDictionary<
        DynamicFilterValues,
        XLFilterDynamicType
    > DynamicFilterMap = new Dictionary<DynamicFilterValues, XLFilterDynamicType>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLDateTimeGrouping
    > DateTimeGroupingMap = new Dictionary<DateTimeGroupingValues, XLDateTimeGrouping>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLLineStyle
    > StrokeLineStyleMap = new Dictionary<Vml.StrokeLineStyleValues, XLLineStyle>
    {
    ...
    > ConditionalFormatMap = new Dictionary<ConditionalFormatValues, XLConditionalFormatType>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLCFContentType
    > ConditionalFormatValueObjectMap = new Dictionary<
        ConditionalFormatValueObjectValues,
        XLCFContentType
    >
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLCFOperator
    > ConditionalFormattingOperatorMap = new Dictionary<
        ConditionalFormattingOperatorValues,
        XLCFOperator
    >
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLSparklineType
    > SparklineTypeMap = new Dictionary<X14.SparklineTypeValues, XLSparklineType>
    {
    ...
    private static readonly IReadOnlyDictionary<
        X14.SparklineAxisMinMaxValues,
        XLSparklineAxisMinMax
    > SparklineAxisMinMaxMap = new Dictionary<X14.SparklineAxisMinMaxValues, XLSparklineAxisMinMax>
    {
    ...
    private static readonly IReadOnlyDictionary<
        X14.DisplayBlanksAsValues,
        XLDisplayBlanksAsValues
    > DisplayBlanksAsMap = new Dictionary<X14.DisplayBlanksAsValues, XLDisplayBlanksAsValues>
    {
    ...
    private static readonly IReadOnlyDictionary<
        ...
        XLPivotAxis
    > PivotTableAxisMap = new Dictionary<PivotTableAxisValues, XLPivotAxis>
    {
    ...
    private static readonly IReadOnlyDictionary<
        FormatActionValues,
        XLPivotFormatAction
    > FormatActionMap = new Dictionary<FormatActionValues, XLPivotFormatAction>
    {

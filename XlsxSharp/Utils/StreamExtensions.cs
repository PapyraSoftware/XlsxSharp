...
internal static class StreamExtensions
{
    ...
    {
        byte b1 = stream.ReadU8();
        byte b2 = stream.ReadU8();
        byte b3 = stream.ReadU8();
        byte b4 = stream.ReadU8();
    ...
    {
        if (!TryReadU16BE(stream, out ushort number))
        {
    ...
    {
        if (!TryReadU32BE(stream, out uint number))
        {
            throw EndOfStreamException();
        }
    ...
    {
        if (!TryReadU32LE(stream, out uint number))
        {
            throw EndOfStreamException();
        }
    ...
    {
        if (!TryReadLE(stream, 4, out int result))
        {
            number = 0;
            return false;
        }
    ...
    {
        if (!TryReadU16LE(stream, out ushort number))
        {
            throw EndOfStreamException();
        }
    ...
    {
        if (!TryReadLE(stream, 2, out int result))
        {
            number = 0;
            return false;
        }
    ...
    {
        if (!TryReadBE(stream, 3, out int result))
        {
            throw EndOfStreamException();
        }
    ...
    {
        if (!TryReadLE(stream, 3, out int result))
        {
            throw EndOfStreamException();
        }
    ...
    {
        if (!TryReadBE(stream, 4, out int readNumber))
        {
            number = 0;
            return false;
        }
    ...
    {
        if (TryReadBE(stream, 2, out int readNumber))
        {

...
internal static class OpenXmlHelper
{
    ...
    /// <summary>
    /// Convert color in XlsxSharp representation to specified OpenXML type.
    /// </summary>
...
#nullable disable
    ...
    internal static void LoadBorder(Border borderSource, IXLBorder border)
    {
        ...
        LoadBorderValues(
            borderSource.DiagonalBorder,
            border.SetDiagonalBorder,
            border.SetDiagonalBorderColor
        );
        ...
        LoadBorderValues(
            borderSource.RightBorder,
            border.SetRightBorder,
            border.SetRightBorderColor
        );
        LoadBorderValues(borderSource.TopBorder, border.SetTopBorder, border.SetTopBorderColor);
        LoadBorderValues(
            borderSource.BottomBorder,
            border.SetBottomBorder,
            border.SetBottomBorderColor
        );
    }

    private static void LoadBorderValues(
        BorderPropertiesType source,
        Func<XLBorderStyleValues, IXLStyle> setBorder,
    ...
    internal static void LoadFont(OpenXmlElement fontSource, IXLFontBase fontBase)
    {
        ...
        Color fontColor = fontSource
            .Elements<DocumentFormat.OpenXml.Spreadsheet.Color>()
            .FirstOrDefault();
        if (fontColor != null)
        {
        ...
        FontFamily fontFamilyNumbering = fontSource
            .Elements<DocumentFormat.OpenXml.Spreadsheet.FontFamily>()
            .FirstOrDefault();
        ...
        FontSize fontSize = fontSource.Elements<FontSize>().FirstOrDefault();
        if (fontSize != null)
        {
        ...
        Underline underline = fontSource.Elements<Underline>().FirstOrDefault();
        if (underline != null)
        {
            fontBase.Underline =
                underline.Val != null
        ...
        VerticalTextAlignment verticalTextAlignment = fontSource
            .Elements<VerticalTextAlignment>()
            .FirstOrDefault();
        ...
        FontScheme fontScheme = fontSource.Elements<FontScheme>().FirstOrDefault();
...
#nullable enable
    ...
    /// <summary>
    /// Here we perform the actual conversion from OpenXML color to XlsxSharp color.
    /// </summary>
    ...
    private static XLColor ConvertToClosedXMLColor(IColorTypeAdapter openXMLColor)
    {
        ...
        {
            System.Drawing.Color thisColor = ColorStringParser.ParseFromArgb(
                openXMLColor.Rgb.Value.AsSpan()
            );

...
public class F : IAstFactory<ScalarValue, AstNode, Ctx>
{
    ...
    public AstNode ArrayNode(
        ...
        int rows,
        int columns,
        IReadOnlyList<ScalarValue> array
    )
    {
    ...
    public AstNode ExternalSheetReference(
        Ctx _,
        SymbolRange range,
        int workbookIndex,
        string sheet,
    ...
    public AstNode ExternalReference3D(
        Ctx _,
        SymbolRange range,
        int workbookIndex,
        string firstSheet,
    ...
    {
        return new FunctionNode(null, name.ToString()) { Children = [.. args] };
    }
    ...
    {
        return new FunctionNode(sheet, name.ToString()) { Children = [.. args] };
    }

    public AstNode ExternalFunction(
        Ctx _,
        SymbolRange range,
        int workbookIndex,
        string sheetName,
    ...
    public AstNode StructureReference(
        Ctx _,
        SymbolRange range,
    ...
    public AstNode ExternalStructureReference(
        Ctx _,
        SymbolRange range,
        int workbookIndex,
        string table,
    ...
    {
        return new ExternalStructureReferenceNode(
            workbookIndex,
            table,
            area,
            firstColumn,
    ...
    {
        return new CellFunctionNode(cell) { Children = [.. args] };
    }
    ...
    public AstNode ExternalSheetName(
        Ctx _,
        SymbolRange range,
        int workbookIndex,
        string sheet,
    ...
    {
        return new UnaryNode(operation) { Children = [node] };
    }

...
internal readonly struct Token
{
    ...
    {
        return this.SymbolId == other.SymbolId && this.StartIndex == other.StartIndex && this.Length == other.Length;
    }
    ...
    public override string ToString() => $"Symbol: {this.SymbolId}; StartIdx: {this.StartIndex}; Len: {this.Length}";
}

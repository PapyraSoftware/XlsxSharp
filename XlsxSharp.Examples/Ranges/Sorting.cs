...
public class Sorting : IXLExample
{
    public void Create(string filePath)
    {
        using (XLWorkbook wb = new())
        {
            ...
            IXLTable table = wsTable.RangeUsed().AsTable();
            ...
            IXLWorksheet wsRows = wb.Worksheets.Add("Rows");
            AddTestTable(wsRows);
            wsRows.Row(1).Sort();
            ...
            IXLWorksheet wsColumns = wb.Worksheets.Add("Columns");
            ...
            IXLWorksheet wsMixed = wb.Worksheets.Add("Mixed");
            ...
            IXLWorksheet wsNumbers = wb.Worksheets.Add("Numbers");
            ...
            IXLWorksheet wsTimeSpans = wb.Worksheets.Add("TimeSpans");
            ...
            IXLWorksheet wsDates = wb.Worksheets.Add("Dates");
            ...
            IXLWorksheet wsIncludeBlanks = wb.Worksheets.Add("Include Blanks");
            AddTestTable(wsIncludeBlanks);
            IXLWorksheet rangeIncludeBlanks = wsIncludeBlanks;
            ...
            IXLWorksheet wsIncludeBlanksColumn = wb.Worksheets.Add("Include Blanks Column");
            AddTestColumn(wsIncludeBlanksColumn);
            IXLWorksheet rangeIncludeBlanksColumn = wsIncludeBlanksColumn;
            rangeIncludeBlanksColumn.SortColumns.Add(1, XLSortOrder.Ascending, false, true);
            rangeIncludeBlanksColumn.Sort();

            IXLWorksheet wsIncludeBlanksColumnDesc = wb.Worksheets.Add(
                "Include Blanks Column Desc"
            );
            AddTestColumn(wsIncludeBlanksColumnDesc);
            IXLWorksheet rangeIncludeBlanksColumnDesc = wsIncludeBlanksColumnDesc;
            ...
            IXLWorksheet wsCaseSensitive = wb.Worksheets.Add("Case Sensitive");
            AddTestTable(wsCaseSensitive);
            IXLWorksheet rangeCaseSensitive = wsCaseSensitive;
            ...
            IXLWorksheet wsCaseSensitiveColumn = wb.Worksheets.Add("Case Sensitive Column");
            AddTestColumn(wsCaseSensitiveColumn);
            IXLWorksheet rangeCaseSensitiveColumn = wsCaseSensitiveColumn;
            rangeCaseSensitiveColumn.SortColumns.Add(1, XLSortOrder.Ascending, true, true);
            rangeCaseSensitiveColumn.Sort();

            IXLWorksheet wsCaseSensitiveColumnDesc = wb.Worksheets.Add(
                "Case Sensitive Column Desc"
            );
            AddTestColumn(wsCaseSensitiveColumnDesc);
            IXLWorksheet rangeCaseSensitiveColumnDesc = wsCaseSensitiveColumnDesc;
            ...
            IXLWorksheet wsSimpleDesc = wb.Worksheets.Add("Simple Desc");
            AddTestTable(wsSimpleDesc);
            wsSimpleDesc.Sort("", XLSortOrder.Descending);

            IXLWorksheet wsSimpleColumns = wb.Worksheets.Add("Simple Columns");
            ...
            IXLWorksheet wsSimpleColumnDesc = wb.Worksheets.Add("Simple Column Desc");
    ...
    {
        ws.Cell("A1")
            .SetValue(new DateTime(2011, 1, 30))
        ...
        ws.Cell("A3")
            .SetValue(new TimeSpan(1, 1, 12, 30))
        ...
        ws.Cell("A7")
            .SetValue(new TimeSpan(9, 4, 30))
            .Style.Fill.SetBackgroundColor(XLColor.IndianRed);
        ws.Cell("A8")
            .SetValue(new DateTime(2011, 4, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DeepPink);
    }
    ...
    {
        ws.Cell("A1")
            .SetValue(new TimeSpan(0, 12, 35, 21))
            .Style.Fill.SetBackgroundColor(XLColor.LightGreen);
        ws.Cell("A2")
            .SetValue(new TimeSpan(45, 1, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DarkTurquoise);
        ws.Cell("A3")
            .SetValue(new TimeSpan(1, 1, 12, 30))
            .Style.Fill.SetBackgroundColor(XLColor.BurlyWood);
        ws.Cell("A4").SetValue(Blank.Value).Style.Fill.SetBackgroundColor(XLColor.DarkGray);
        ws.Cell("A5").SetValue(Blank.Value).Style.Fill.SetBackgroundColor(XLColor.DarkSalmon);
        ws.Cell("A6")
            .SetValue(new TimeSpan(0, 12, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DodgerBlue);
        ws.Cell("A7")
            .SetValue(new TimeSpan(1, 4, 30))
            .Style.Fill.SetBackgroundColor(XLColor.IndianRed);
        ws.Cell("A8")
            .SetValue(new TimeSpan(1, 4, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DeepPink);
    }
    ...
    private static void AddTestColumnDates(IXLWorksheet ws)
    {
        ws.Cell("A1")
            ...
            .Style.Fill.SetBackgroundColor(XLColor.LightGreen);
        ws.Cell("A2")
            .SetValue(new DateTime(2011, 1, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DarkTurquoise);
        ws.Cell("A3")
            .SetValue(new DateTime(2011, 12, 30))
            .Style.Fill.SetBackgroundColor(XLColor.BurlyWood);
        ws.Cell("A4").SetValue(Blank.Value).Style.Fill.SetBackgroundColor(XLColor.DarkGray);
        ws.Cell("A5").SetValue(Blank.Value).Style.Fill.SetBackgroundColor(XLColor.DarkSalmon);
        ws.Cell("A6")
            .SetValue(new DateTime(2011, 12, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DodgerBlue);
        ws.Cell("A7")
            .SetValue(new DateTime(2011, 4, 30))
            .Style.Fill.SetBackgroundColor(XLColor.IndianRed);
        ws.Cell("A8")
            .SetValue(new DateTime(2011, 4, 15))
            .Style.Fill.SetBackgroundColor(XLColor.DeepPink);

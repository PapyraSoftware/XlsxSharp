    ...
    public void Create(string filePath)
    {
        using (XLWorkbook wb = new())
        {
            ...
            )
            {
                ...
                ws.AddPicture(fs, XLPictureFormat.Png, "Image10").MoveTo(220, 150);
                ...
                fs.Position = 0;
                ws.AddPicture(fs, XLPictureFormat.Png, "Image11").MoveTo(ws.Cell(1, 1));
            ...
            )
            {
                ...
                ws.AddPicture(fs, XLPictureFormat.Jpeg).MoveTo(100, 600).Delete();
            }

...
namespace XlsxSharp.Examples.PivotTables;
...
public class PivotTables : IXLExample
{
    ...
    public void Create(string filePath)
    {
        ...
        using (XLWorkbook wb = new())
        {
            ...
            IXLTable table = ws.Cell(1, 1).InsertTable(pastries, "PastrySalesData", true);
            ...
            for (int i = 1; i <= 3; i++)
            {
                ...
                if (i > 1)
                {
                    pt.Values.Add("Quality", "Sum of Quality").NumberFormat.SetFormat("#,##0.00");
                }
                if (i > 2)
                {
            ...
            pt.ReportFilters.Add("Name").AddSelectedValue("Scone").AddSelectedValue("Doughnut");

            pt.ReportFilters.Add("Quality").AddSelectedValue(5.19);

            pt.ReportFilters.Add("BakeDate").AddSelectedValue(new DateTime(2017, 05, 03));

...
public class ShowCase : IXLExample
{
    public void Create(string filePath)
    {
        ...
        //Adding a worksheet
        IXLWorksheet ws = wb.Worksheets.Add("Contacts");
        ...
        //From another range
        IXLRange rngDates = rngTable.Range("E4:E6");
        IXLRange rngNumbers = rngTable.Range("F4:F6");
        ...
        //Formatting headers
        IXLRange rngHeaders = rngTable.Range("B3:F3");
        ...
        IXLRange rngData = ws.Range("B3:F6");
        IXLTable excelTable = rngData.CreateTable();

...
public class DataValidation : IXLExample
{
    ...
    {
        XLWorkbook wb = new();
        IXLWorksheet ws = wb.Worksheets.Add("Data Validation");

        // Decimal between 1 and 5
        ws.Cell(1, 1).CreateDataValidation().Decimal.Between(1, 5);

        // Whole number equals 2
        IXLDataValidation dv1 = ws.Range("A2:A3").CreateDataValidation();
        ...
        IXLDataValidation dv2 = ws.Cell("A4").CreateDataValidation();
        ...
        wb.AddWorksheet("Copy From Range 1")
            .FirstCell()
            .CopyFrom(ws.RangeUsed(XLCellsUsedOptions.All));
        wb.AddWorksheet("Copy From Range 2")
            .FirstCell()
            .CopyFrom(ws2.RangeUsed(XLCellsUsedOptions.All));

...
public class Formulas : IXLExample
{
    public virtual void Create(String filePath)
    {
        ...
        ws.Cell(2, 1).Value = 1;
        ws.Cell(2, 2).Value = 2;
        IXLCell cellWithFormulaA1 = ws.Cell(2, 3);
        // Use A1 notation
        ...
        ws.Cell(3, 1).Value = 1;
        ws.Cell(3, 2).Value = 2;
        IXLCell cellWithFormulaR1C1 = ws.Cell(3, 3);
        // Use R1C1 notation
        ...
        ws.Cell(4, 1).Value = "A";
        ws.Cell(4, 2).Value = "B";
        IXLCell cellWithStringFormula = ws.Cell(4, 3);
        ...
        IXLRange rngData = ws.Range(2, 1, 4, 7);

...
public class CellValues : IXLExample
{
    public void Create(string filePath)
    {
        ...
        {
            IXLWorksheet ws = workbook.Worksheets.Add("Cell Values");
            ...
            IXLCell cellDateTime = ws.Cell(3, 2);
            ...
            // The apostrophe is to force XlsxSharp to treat the date as a string
            ...
            IXLCell cellBoolean = ws.Cell(4, 2);
            ...
            // Set the values back to cells
            // The apostrophe is to force XlsxSharp to treat the boolean as a string
            ...
            IXLCell cellDouble = ws.Cell(5, 2);
            ...
            // Set the values back to cells
            // The apostrophe is to force XlsxSharp to treat the double as a string
            ...
            IXLCell cellString = ws.Cell(6, 2);
            ...
            IXLCell cellTimeSpan = ws.Cell(7, 2);
            ...
            IXLRange rngTitle = ws.Range("B2:G2");

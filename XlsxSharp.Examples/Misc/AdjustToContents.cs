...
public class AdjustToContents : IXLExample
{
    public void Create(string filePath)
    {
        ...
        {
            IXLWorksheet ws = wb.Worksheets.Add("Adjust To Contents");
            ...
            for (int co = 0; co < 90; co += 5)
            {
                ws2.Cell(1, (co / 5) + 2)
                    ...
                    .Style.Alignment.TextRotation = co;
            }
            ...
            for (int ro = 0; ro < 90; ro += 5)
            {
                ws3.Cell((ro / 5) + 2, 1)
                    ...
                    .Style.Alignment.TextRotation = ro;
            }
            ...
            IXLWorksheet ws6 = wb.Worksheets.Add("Absurdly wide column");

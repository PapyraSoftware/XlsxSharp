...
public class StyleBorder : IXLExample
{
    public void Create(String filePath)
    {
        ...
        IXLWorksheet ws = workbook.Worksheets.Add("Style Border");
        ...
        ws.Cell(++ro, co).Value =
            "DiagonalBorder = Thin; DiagonalBorderColor = Red; DiagonalUp = true";
        ...
        ws.Cell(++ro, co).Value =
            "DiagonalBorder = Thin; DiagonalBorderColor = Red; DiagonalDown = true";
        ws.Cell(ro, co).Style.Border.DiagonalBorder = XLBorderStyleValues.Thin;
        ws.Cell(ro, co).Style.Border.DiagonalBorderColor = XLColor.Red;
        ws.Cell(ro, co).Style.Border.DiagonalDown = true;

        ws.Cell(++ro, co).Value =
            "DiagonalBorder = Thin; DiagonalBorderColor = Red; DiagonalUp = true; DiagonalDown = true";
        ws.Cell(ro, co).Style.Border.DiagonalBorder = XLBorderStyleValues.Thin;
        ws.Cell(ro, co).Style.Border.DiagonalBorderColor = XLColor.Red;
        ws.Cell(ro, co).Style.Border.DiagonalUp = true;
        ws.Cell(ro, co).Style.Border.DiagonalDown = true;

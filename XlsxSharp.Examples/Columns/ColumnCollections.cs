...
public class ColumnCollection : IXLExample
{
    public void Create(String filePath)
    {
        ...
        IXLWorksheet ws = workbook.Worksheets.Add("Columns of a Range");

        // All columns in a range
        ws.Range("A1:B2").Columns().Style.Fill.BackgroundColor = XLColor.DimGray;

        IXLRange bigRange = ws.Range("A4:V6");
        ...
        IXLWorksheet ws2 = workbook.Worksheets.Add("Columns of a worksheet");

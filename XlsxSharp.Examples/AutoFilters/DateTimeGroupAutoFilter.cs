    ...
    public void Create(string filePath)
    {
        using (XLWorkbook wb = new())
        {
            ...
            ws.Cell("A1")
                .SetValue("Dates")
                .CellBelow()
                .SetValue(new DateTime(2018, 1, 1).AddDays(2))
                .CellBelow()
                .SetValue(new DateTime(2018, 1, 1).AddDays(3))
                .CellBelow()
                .SetValue(new DateTime(2018, 1, 1).AddDays(3))
                .CellBelow()
                .SetValue(new DateTime(2018, 1, 1).AddDays(5))
                .CellBelow()
                .SetValue(new DateTime(2018, 1, 1).AddDays(1))
                .CellBelow()
                .SetValue(new DateTime(2018, 1, 1).AddDays(4));
            ...
            ws.RangeUsed()
                .SetAutoFilter()
                .Column(1)
                .AddDateGroupFilter(new DateTime(2018, 1, 1).AddDays(3), XLDateTimeGrouping.Day);

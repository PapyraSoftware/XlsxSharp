...
using XlsxSharp.Examples.PageSetup;
using XlsxSharp.Examples.Ranges;
using XlsxSharp.Examples.Rows;
using XlsxSharp.Examples.Styles;
using XlsxSharp.Examples.Tables;

namespace XlsxSharp.Examples.Creating;

public class CreateFiles
{
    public static void CreateAllFiles()
    {
        string path = Program.BaseCreatedDirectory;
        ...
        new AdjustToContentsWithAutoFilter().Create(
            Path.Combine(path, "AdjustToContentsWithAutoFilter.xlsx")
        );
        ...
        new AddingDataTableAsWorksheet().Create(
            Path.Combine(path, "AddingDataTableAsWorksheet.xlsx")
        );

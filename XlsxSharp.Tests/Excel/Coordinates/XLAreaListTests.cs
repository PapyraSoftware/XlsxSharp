...
internal class XLAreaListTests
{
    ...
    public bool IntersectsWith_determines_intersection_with_any_area(
        string areaListText,
        string areaText
    )
    {
    ...
    public string IntersectingWith_returns_areas_intersecting_with_the_other_area(
        string areaListText,
        string areaText
    )
    {
    ...
    public string Excluding_returns_area_list_without_excluded(
        string areaListText,
    ...
    public string TryCopyAreaTo_return_list_of_intersecting_areas_shifted_to_target(
        string areaListText,
    ...
    )
    {
        ...
        return areaList.TryCopyAreaTo(targetPoint, areaToCopy, out XLAreaList? result)
            ? result.ToSpaceList()
            : null;
    }

...
public class ConditionalFormatShiftTests
{
    ...
    private static IEnumerable<
        TestCaseData<string, Action<IXLWorksheet>, string>
    > GetSplitTestCases()
    {
        yield return new TestCaseData<string, Action<IXLWorksheet>, string>(
            "A1:C3",
        ...
        yield return new TestCaseData<string, Action<IXLWorksheet>, string>(
            "A1:C3",
            ws => ws.Range("A2").InsertColumnsBefore(2),
            "A1:C1 C2:E2 A3:C3"
        );
        yield return new TestCaseData<string, Action<IXLWorksheet>, string>(
            "A10:C12",
    ...
    private static IEnumerable<
        TestCaseData<string, string, Action<IXLWorksheet>, string>
    > GetFormulaShiftTestCases()
    {
        // Smoke test
        yield return new TestCaseData<string, string, Action<IXLWorksheet>, string>(
            "A1",
            "=B1",
        ...
        yield return new TestCaseData<string, string, Action<IXLWorksheet>, string>(
            "A2",
            "=Other!A2",
            ws => ws.Row(1).InsertRowsAbove(10),
            "Other!A2"
        );

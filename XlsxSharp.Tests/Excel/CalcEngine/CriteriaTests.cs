...
internal class CriteriaTests
{
    ...
    public static IEnumerable<object> CriteriaTestCases
    {
        get
        {
            ...
            static object[] S(ScalarValue s, XLCellValue v) => [s, v, true];

            static object[] F(ScalarValue s, XLCellValue v) => [s, v, false];
        }
    }
}

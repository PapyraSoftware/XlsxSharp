...
public class XLRangeBaseTests
{
    ...
    public void TableRange()
    {
        ...
        Assert.IsTrue(
            namedRange
                ...
                .SequenceEqual(new[] { "John", "Hank", "Dagny" })
        );
    }
    ...
    public void RangesRemoveAllWithoutDispose()
    {
        ...
        List<IXLRange> rangesCopy = [.. ranges];
    ...
    public void RangesRemoveAllByCriteria()
    {
        ...
        IXLRange otherRange = ws.Range("A3:D3");
    ...
    public void XLRangesReturnsRangesInDeterministicOrder()
    {
        ...
        IXLWorksheet ws2 = wb.Worksheets.Add("Another sheet");
    ...
    )
    {
        ...
        XLRange? range = ws.Range(rangeAddress) as XLRange;
        IXLRange splitter = ws.Range(splitBy);

        IEnumerable<XLRange> result = range.Split(splitter.RangeAddress, includeIntersection);

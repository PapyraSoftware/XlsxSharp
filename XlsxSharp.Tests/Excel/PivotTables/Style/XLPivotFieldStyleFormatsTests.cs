    ...
    public void Modify_pivot_field_label_style() =>
        TestHelper.CreateAndCompare(
            wb =>
            {
                ...
                IXLPivotField monthField = pt.RowLabels.Add("Month");
                pt.Values.Add("Price");

                // Modify style in two steps to ensure second modification doesn't override the first one
                monthField
                    .StyleFormats.Label.Style.Fill.SetBackgroundColor(XLColor.LightGray)
    ...
    public void Set_pivot_field_header_style(XLPivotLayout layout, string testFile) =>
        ...
        TestHelper.CreateAndCompare(
            wb =>
            {
                ...
                IXLPivotField styledHeaderField = pt.ColumnLabels.Add("Flavor");
    ...
    public void Set_pivot_field_subtotals_style() =>
        ...
        TestHelper.CreateAndCompare(
            wb =>
            {
                ...
                monthField
                    .StyleFormats.Subtotal.Style.Font.SetFontColor(XLColor.Green)
                    .Font.SetBold();
    ...
    public void Style_values_at_intersection_of_row_and_column() =>
        ...
        TestHelper.CreateAndCompare(
            wb =>
            {
                ...
                IXLPivotField flavorColumnField = pt.ColumnLabels.Add("Flavor");
                pt.Values.Add("Price");
                ...
                nameRowField.StyleFormats.DataValuesFormat.Style.Font.SetFontColor(XLColor.Red);
                monthRowField
                    .StyleFormats.DataValuesFormat.AndWith(flavorColumnField)
    ...
    public void Style_data_cells_at_intersection_of_values_field_and_row_or_column_field() =>
        ...
        TestHelper.CreateAndCompare(
            wb =>
            {
                ...
                IXLPivotField flavorField = pt.ColumnLabels.Add("Flavor");
                pt.Values.Add("Price");
                IXLPivotValue maxPrice = pt
                    .Values.Add("Price", "Max Price")
                    .SetSummaryFormula(XLPivotSummary.Maximum);

                flavorField
                    .StyleFormats.DataValuesFormat.ForValueField(maxPrice)
                    .Style.Fill.BackgroundColor = XLColor.LightBlue;
            },
    ...
    public void Style_data_cells_at_intersection_of_value_field_and_axis_field_with_specific_values() =>
        TestHelper.CreateAndCompare(
            wb =>
            {
                ...
                IXLPivotField nameField = pt.RowLabels.Add("Name");
                IXLPivotField flavorField = pt.ColumnLabels.Add("Flavor");
                pt.Values.Add("Price");
                ...
                nameField
                    .StyleFormats.DataValuesFormat.AndWith(
                        nameField,
                        x => x.IsText && x.GetText() == "Waffle"
                    )
                    .AndWith(
                        flavorField,
                        x => x.IsText && x.GetText() == "Peach" || x.GetText() == "Chocolate"
                    )
                    .Style.Fill.BackgroundColor = XLColor.LightBlue;
            },

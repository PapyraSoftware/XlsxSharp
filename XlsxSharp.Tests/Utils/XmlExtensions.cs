...
internal static class XmlExtensions
{
    ...
    public static bool SemanticallyEqual(this XElement? lhs, XElement? rhs)
    {
        ...
        IOrderedEnumerable<XAttribute> lhsAttr = lhs.Attributes()
            .Where(a => !a.IsNamespaceDeclaration)
            .OrderBy(a => a.Name.LocalName)
            .ThenBy(a => a.Name.Namespace);
        IOrderedEnumerable<XAttribute> rhsAttr = rhs.Attributes()
            .Where(a => !a.IsNamespaceDeclaration)
            .OrderBy(a => a.Name.LocalName)
            .ThenBy(a => a.Name.Namespace);
        ...
        XNode? lhsNode = lhs.FirstNode;
        XNode? rhsNode = rhs.FirstNode;

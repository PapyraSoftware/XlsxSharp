...
public class StylesTests
{
    ...
    [Test]
    public void StyleBorder() => TestHelper.RunTestExample<StyleBorder>(@"Styles\StyleBorder.xlsx");

    [Test]
    public void StyleFill() => TestHelper.RunTestExample<StyleFill>(@"Styles\StyleFill.xlsx");

    [Test]
    public void StyleFont() => TestHelper.RunTestExample<StyleFont>(@"Styles\StyleFont.xlsx");
    ...
    [Test]
    public void UsingColors() => TestHelper.RunTestExample<UsingColors>(@"Styles\UsingColors.xlsx");

...
public class RangesTests
{
    ...
    public void InsertingDeletingColumns() =>
        TestHelper.RunTestExample<InsertingDeletingColumns>(
            @"Ranges\InsertingDeletingColumns.xlsx"
        );
    ...
    [Test]
    public void SortExample() => TestHelper.RunTestExample<SortExample>(@"Ranges\SortExample.xlsx");

    [Test]
    public void Sorting() => TestHelper.RunTestExample<Sorting>(@"Ranges\Sorting.xlsx");

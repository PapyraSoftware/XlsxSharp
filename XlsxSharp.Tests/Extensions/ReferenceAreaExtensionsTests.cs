...
internal class ReferenceAreaExtensionsTests
{
    ...
    {
        ReferenceArea reference = ReferenceParser.ParseA1(referenceText);
        Area inserted = Area.Parse(insertedArea);
        ReferenceArea? expected = expectedText is not null
            ? ReferenceParser.ParseA1(expectedText)
            : null;
    ...
    {
        // C5
        yield return [new ReferenceArea(Relative, 5, Relative, 3, A1), new Area(5, 3, 5, 3)];

        // C5:E14
        yield return
        [
            new ReferenceArea(
                new RowCol(Relative, 5, Relative, 3, A1),
                new RowCol(Relative, 14, Relative, 5, A1)
            ),
            new Area(5, 3, 14, 5),
        ];
        ...
        [
            new ReferenceArea(
                new RowCol(Relative, 3, Absolute, 2, A1),
                new RowCol(Absolute, 10, Relative, 5, A1)
            ),
            new Area(3, 2, 10, 5),
        ];
        ...
        [
            new ReferenceArea(
                new RowCol(Absolute, 3, Absolute, 2, A1),
                new RowCol(Absolute, 10, Absolute, 5, A1)
            ),
            new Area(3, 2, 10, 5),
        ];
        ...
        [
            new ReferenceArea(
                new RowCol(Relative, 10, Relative, 2, A1),
                new RowCol(Absolute, 3, Absolute, 5, A1)
            ),
            new Area(3, 2, 10, 5),
        ];
        ...
        [
            new ReferenceArea(
                new RowCol(None, 0, Relative, 3, A1),
                new RowCol(None, 0, Relative, 5, A1)
            ),
        ...
        [
            new ReferenceArea(
                new RowCol(Relative, 14, None, 0, A1),
                new RowCol(Relative, 30, None, 0, A1)
            ),
    ...
    public static IEnumerable<object[]> R1C1TestCases()
    {
        ...
        [
            new Point(754, 5742),
            new ReferenceArea(
                new RowCol(Absolute, 3, Absolute, 2, R1C1),
                new RowCol(Absolute, 7, Absolute, 4, R1C1)
            ),
            Area.Parse("B3:D7"),
        ];
        ...
        [
            new Point(3, 6),
            new ReferenceArea(
                new RowCol(Relative, 4, Relative, -1, R1C1),
                new RowCol(Relative, 6, Relative, 3, R1C1)
            ), // R[4]C[-1]:R[6]C[3]
            new Area(7, 5, 9, 9),
        ];
        ...
        [
            new Point(3, 6),
            new ReferenceArea(
                new RowCol(Relative, 6, Relative, -1, R1C1),
                new RowCol(Relative, 4, Relative, 3, R1C1)
            ), // R[6]C[-1]:R[4]C[3]
            new Area(7, 5, 9, 9),
        ];
    }
